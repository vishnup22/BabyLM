...
#SBATCH --output=/nfs/storage1/home/pulipakv/BabyLM/logs/eval_small_english_%j.out
#SBATCH --error=/nfs/storage1/home/pulipakv/BabyLM/logs/eval_small_english_%j.err
