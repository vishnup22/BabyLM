...
#SBATCH --output=/nfs/storage1/home/pulipakv/BabyLM/logs/eval_small_hindi_%j.out
#SBATCH --error=/nfs/storage1/home/pulipakv/BabyLM/logs/eval_small_hindi_%j.err
