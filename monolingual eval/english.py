...
def main():
    ...
    out_stem   = Path(args.output).stem          # e.g. "results_english"
    out_dir    = Path(args.output).parent
    eval_results = {e: {} for e in args.evals}   # per-eval accumulator
    ...
    for name in args.models:
        ...
        if "blimp" in args.evals:
            save_eval("blimp", name,
                      eval_blimp(model, tokenizer, arch, device, extras))
