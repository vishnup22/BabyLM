...
def get_config():
    ...
    parser.add_argument('--curriculum', action='store_true',
                        help="If set, load data from curriculum_file in fixed order (no shuffle)")
    parser.add_argument('--curriculum_file', type=str,
                        help="Path to the curriculum-ordered .txt file (one sentence per line)")
