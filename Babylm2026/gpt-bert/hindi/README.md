...
- shared cleaned text from: `../../gpt-2/hindi/data/translated-babylm-hindi`
...
- This bundle reuses the cleaned text prepared by `gpt-2/hindi` to save disk space.
- Make sure `gpt-2/hindi` has already finished download + cleaning before running tokenizer/shard prep here.
