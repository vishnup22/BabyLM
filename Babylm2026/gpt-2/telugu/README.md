# Telugu BabyLM Strict GPT-2

This folder is a self-contained copy of the `strict-gpt2` training path adapted for the translated Telugu BabyLM dataset.

It is set up to train a GPT-2 model from scratch on:

- Hugging Face dataset: `pulipakav-1/translated-babylm-telugu`
- local dataset folder: `data/translated-babylm-telugu`
...
- `data/translated-babylm-telugu/`
- `tokenizers/translated-babylm-telugu/`
- `configs/translated-babylm-telugu/`
- `experiments/telugu-strict-100m/`
...
- `training.py` expects the tokenizer under `./tokenizers/translated-babylm-telugu` and the model config under `./configs/translated-babylm-telugu`.
